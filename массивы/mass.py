...
def main():
    ...
    print(f"пузырьком: {bubble_time:.6f} ")
    print(f"вставками: {insertion_time:.6f} ")
    print(f"слиянием: {merge_time:.6f} ")
    print(f"сортировка: {quick_time:.6f} ")
    print(f"подсчетом: {counting_time:.6f} ")
